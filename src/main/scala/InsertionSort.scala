...
object InsertionSort extends App {
  //For String
   def insertionSortSeqForString(array: Vector[String]): Vector[String] = {
    var key = ""
    var j = 0
    var sorted = array
  ...
  def insertionSortPar(array: Vector[String]): Vector[String] = {
    var sorted = array
    var key = ""
    var j = 0
    ...
    def merge(left: Vector[String], right: Vector[String]): Vector[String] = {
      var mutLeft = left
      var mutRight = right
  ...
  // For Float
  def insertionSortSeqForFloat(array: Vector[Float]): Vector[Float] = {
    var key = 0f
    var j = 0
    var sorted = array
  ...
  def insertionSortPar(array: Vector[Float]): Vector[Float] = {
    var sorted = array
    var key = 0f
    var j = 0
    ...
    def merge(left: Vector[Float], right: Vector[Float]): Vector[Float] = {
      var mutLeft = left
      var mutRight = right
      var merged = left ++ right
      var m = 0
  ...
  // For Integer
  def insertionSortSeqForInteger(array: Vector[Int]): Vector[Int] = {
    var key = 0
    var j = 0
    var sorted = array
